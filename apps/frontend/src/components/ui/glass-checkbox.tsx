    ...
    <div className="flex items-center gap-3">
      <CheckboxPrimitive.Root
        ...
        className={cn(
          ...
          'focus-visible:ring-2 focus-visible:ring-cyan-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent focus-visible:outline-none',
      ...
      {label && (
        <label
          htmlFor={checkboxId}
          className="cursor-pointer text-sm font-medium text-white/80 select-none peer-disabled:opacity-50"
        >
          {label}
        </label>
      )}
